...
docker run --rm -ti --env-file .env -u="$UID" -v "$PWD"/frontend:/src -w /src kkarczmarczyk/node-yarn yarn
docker run --rm -ti --env-file .env -u="$UID" -v "$PWD"/admin:/src -w /src kkarczmarczyk/node-yarn yarn
docker run --rm -ti --env-file .env -u="$UID" -v "$PWD"/api:/src -w /src kkarczmarczyk/node-yarn yarn
